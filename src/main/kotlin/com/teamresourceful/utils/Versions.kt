...
fun Project.getParchmentMavenCoordinate(): String? {
    ...
    return when (getMcVersion()) {
        ...
        "1.21.5" -> create("1.21.5", "2025.06.15")
        "1.21.6" -> create("1.21.6", "2025.06.29")
        "1.21.7" -> create("1.21.7", "2025.07.18")
        "1.21.8" -> create("1.21.8", "2025.09.14")
        "1.21.9" -> create("1.21.9", "2025.10.05")
        "1.21.10" -> create("1.21.10", "2025.10.12")
        else -> null
    }
}
